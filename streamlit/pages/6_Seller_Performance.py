...
from olist_report import (
    run_query, TABLE_FACT, TABLE_SELLERS, TABLE_CUSTOMERS, TABLE_DATES,
    get_state_filter_sql_clause, get_year_filter_sql_clause
)
...
from olist_report import create_state_filter, create_year_filter
...
# --------------------------------
# Tab 2: Customer Review Analysis
# --------------------------------
with tab2:
